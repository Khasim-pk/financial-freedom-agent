...
st.set_page_config(
    page_title="Financial Freedom Action Center",
    page_icon="✅",
    layout="wide",
)
...
st.title("Financial Freedom Action Center")
st.caption("Use this page to update paid bills, card payments, and handloan repayments.")
...
try:
    ...
    fixed_df = load_tab("Fixed_Commitments")
    handloans_df = load_tab("Handloans")
...
with tab_cards:
    ...
    st.caption(
        ...
        "This updates the Credit_Card_Dues tab and records a cash outflow in Transactions."
    )
...
with tab_bills:
    ...
    st.caption(
        "This updates only the Fixed_Commitments tab. "
        "We do not add these to Transactions yet because the main dashboard already reserves fixed commitments automatically."
    )
...
with tab_handloans:
    ...
    st.caption(
        ...
        "This updates the Handloans tab and records a debt-payment cash outflow in Transactions."
    )
